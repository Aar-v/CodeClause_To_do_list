<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        //Update
        if(!empty($id)) {
            $sql = "UPDATE list set task = '".$task."', updated = '".$updated."' where id = ".$id;
            ...
            $sql = "INSERT INTO list (task, created, updated) VALUES ('".$task."', '".$created."', '".$updated."')";
            $res = $obj->executeQuery($sql);
...
<head>
    ...
    <style>
      ...
      *:after {
      ...
      #tasks {
        ...
        width: 100%;
        position: relative;
        background-color: rgb(252, 177, 133);
        padding: 30px 20px;
        margin-top: 10px;
      }
    ...
    <script src="https://kit.fontawesome.com/c220c63012.js" crossorigin="anonymous"></script>
</head>
<body>
